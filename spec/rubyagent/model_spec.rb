...
RSpec.describe Rubyagent::TokenUsage do
...
RSpec.describe Rubyagent::ChatMessage do
  ...
  it "stores tool_calls" do
    tc = [Rubyagent::ToolCall.new(id: "1", function: Rubyagent::ToolCallFunction.new(name: "f", arguments: {}))]
...
RSpec.describe Rubyagent::RunResult do
  it "creates with defaults" do
...
RSpec.describe Rubyagent::ToolCall do
  it "stores function details" do
    tc = described_class.new(
      id: "call_123",
      function: Rubyagent::ToolCallFunction.new(name: "search", arguments: { query: "test" })
    )
