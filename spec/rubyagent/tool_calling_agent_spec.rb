...
RSpec.describe Rubyagent::ToolCallingAgent do
  ...
  describe "#run" do
    ...
    it "processes tool calls and returns results" do
      test_tool = Rubyagent.tool(:multiply, "Multiplies two numbers",
      ...
      response1 = Rubyagent::ChatMessage.new(
        role: "assistant",
        ...
        tool_calls: [
          Rubyagent::ToolCall.new(
            id: "call_1",
            function: Rubyagent::ToolCallFunction.new(name: "multiply", arguments: { "a" => 6, "b" => 7 })
          )
        ]
      )

      # Second response: final answer
      response2 = Rubyagent::ChatMessage.new(
        role: "assistant",
        content: "The result is 42.",
        token_usage: Rubyagent::TokenUsage.new(input_tokens: 30, output_tokens: 20),
        tool_calls: [
          Rubyagent::ToolCall.new(
            id: "call_2",
            function: Rubyagent::ToolCallFunction.new(name: "final_answer", arguments: { "answer" => "42" })
    ...
    it "handles unknown tools gracefully" do
      response1 = Rubyagent::ChatMessage.new(
        ...
        tool_calls: [
          Rubyagent::ToolCall.new(
            id: "call_1",
            function: Rubyagent::ToolCallFunction.new(name: "nonexistent", arguments: {})
          )
        ]
      )
      ...
      response2 = Rubyagent::ChatMessage.new(
        ...
        tool_calls: [
          Rubyagent::ToolCall.new(
            id: "call_2",
            function: Rubyagent::ToolCallFunction.new(name: "final_answer", arguments: { "answer" => "recovered" })
          )
        ]
      )
    ...
    it "returns RunResult when return_full_result is true" do
      response = Rubyagent::ChatMessage.new(
        ...
        tool_calls: [
          Rubyagent::ToolCall.new(
            id: "call_1",
            function: Rubyagent::ToolCallFunction.new(name: "final_answer", arguments: { "answer" => "result" })
          )
        ]
      )
      ...
      expect(result).to be_a(Rubyagent::RunResult)
    ...
    it "handles response with no tool_calls as a thought step" do
      ...
      response2 = Rubyagent::ChatMessage.new(
        ...
        tool_calls: [
          Rubyagent::ToolCall.new(
            id: "call_1",
            function: Rubyagent::ToolCallFunction.new(name: "final_answer", arguments: { "answer" => "thought first" })
          )
        ]
      )
