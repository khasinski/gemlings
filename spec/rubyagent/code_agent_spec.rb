...
RSpec.describe Rubyagent::CodeAgent do
  ...
  describe "step_callbacks" do
    it "invokes callbacks after each step" do
      ...
      expect(steps_seen.first).to be_a(Rubyagent::ActionStep)
    end
  end
  ...
  describe "#interrupt" do
    it "raises InterruptError on next step" do
      ...
      expect { agent.run("Test") }.to raise_error(Rubyagent::InterruptError)
    end
  end
end
