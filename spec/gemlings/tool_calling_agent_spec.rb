...
RSpec.describe Gemlings::ToolCallingAgent do
  ...
  describe "#run" do
      ...
      response = Gemlings::ChatMessage.new(
        ...
        tool_calls: [
          Gemlings::ToolCall.new(
            id: "call_1",
            function: Gemlings::ToolCallFunction.new(name: "final_answer", arguments: { "answer" => "42" })
          )
        ]
      )
    ...
    it "processes tool calls and returns results" do
      test_tool = Gemlings.tool(:multiply, "Multiplies two numbers",
      ...
      response1 = Gemlings::ChatMessage.new(
        ...
        tool_calls: [
          Gemlings::ToolCall.new(
            id: "call_1",
            function: Gemlings::ToolCallFunction.new(name: "multiply", arguments: { "a" => 6, "b" => 7 })
          )
        ]
      )
    ...
    it "handles unknown tools gracefully" do
      response1 = Gemlings::ChatMessage.new(
        ...
        tool_calls: [
          Gemlings::ToolCall.new(
            id: "call_1",
            function: Gemlings::ToolCallFunction.new(name: "nonexistent", arguments: {})
          )
        ]
      )
      ...
      response2 = Gemlings::ChatMessage.new(
        ...
        tool_calls: [
          Gemlings::ToolCall.new(
            id: "call_2",
            function: Gemlings::ToolCallFunction.new(name: "final_answer", arguments: { "answer" => "recovered" })
          )
        ]
      )
    ...
    it "returns RunResult when return_full_result is true" do
      response = Gemlings::ChatMessage.new(
        ...
        tool_calls: [
          Gemlings::ToolCall.new(
            id: "call_1",
            function: Gemlings::ToolCallFunction.new(name: "final_answer", arguments: { "answer" => "result" })
          )
        ]
      )
    ...
    it "handles response with no tool_calls as a thought step" do
      ...
      response2 = Gemlings::ChatMessage.new(
        ...
        tool_calls: [
          Gemlings::ToolCall.new(
            id: "call_1",
            function: Gemlings::ToolCallFunction.new(name: "final_answer", arguments: { "answer" => "thought first" })
          )
        ]
      )
