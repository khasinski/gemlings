...
RSpec.describe Gemlings::Memory do
  ...
  describe "#add_step" do
    it "adds an action step" do
      ...
      expect(step).to be_a(Gemlings::ActionStep)
    ...
    it "supports tool_calls field" do
      tc = [Gemlings::ToolCall.new(id: "1", function: Gemlings::ToolCallFunction.new(name: "test", arguments: {}))]
  ...
  describe "#add_plan" do
    it "adds a planning step" do
      ...
      expect(step).to be_a(Gemlings::PlanningStep)
    end
  end
  ...
  describe "#add_user_message" do
    it "adds a UserMessage to steps" do
      ...
      expect(memory.steps.last).to be_a(Gemlings::UserMessage)
  ...
  describe "#to_messages" do
    ...
    it "handles tool_calls in assistant messages" do
      tc = [Gemlings::ToolCall.new(id: "1", function: Gemlings::ToolCallFunction.new(name: "search", arguments: { q: "test" }))]
  ...
  describe "token tracking" do
    it "accumulates across multiple steps" do
      u1 = Gemlings::TokenUsage.new(input_tokens: 100, output_tokens: 50)
      u2 = Gemlings::TokenUsage.new(input_tokens: 200, output_tokens: 100)
